        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AlternatePhoneNumber = table.Column<long>(type: "bigint", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CarExtraDetails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CarExtraDetails_Cars_CarId",
                        column: x => x.CarId,
                        principalTable: "Cars",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CarId = table.Column<int>(type: "int", nullable: false),
                    Photo1 = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    Photo2 = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    Photo3 = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    Photo4 = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CarExtraDetails_CarId",
                table: "CarExtraDetails",
                column: "CarId");
